...
using XenoForumsApp.AppFlyouts;
#endif
...
namespace XenoForumsApp
{
    ...
    {
        private Guid APP_ID = new Guid("1e09cc71-211c-4517-aac3-7d746487b21b");
        public const string APP_NAME = "XenoForums App";
